...
Table 1. returns the result that tells us if how well each variable performs in the prediction: P-value < 0.05 indicates the variable is significant. R-square at the end gives a percentage of how well our model can control the error. 
