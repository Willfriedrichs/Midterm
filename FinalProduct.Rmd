...
The primary data for the analysis was provided along with the project requirements.  Here we loaded, wrangled, and joined the data with the ACS geographies from above.  Likewise, Boulder County and City boundaries are established from open-source geometry files.  Table 1, below, summarizes key indicators by municipality. 
...
stargazer(reg1, type = "html", title = "variation",out="table1.txt",dep.var.labels = "Housing Price")
